...
output "spoke_2_wan1_subnet_id" {
  value       = aws_subnet.spoke_2_wan1_subnet.id
}

output "spoke_2_wan2_subnet_id" {
  value       = aws_subnet.spoke_2_wan2_subnet.id
}

output "spoke_2_private_subnet_id" {
  value       = aws_subnet.spoke_2_private_subnet.id
}

output "spoke_2_pvt_rt_id" {
  value       = aws_route_table.spoke_2_pvt_rt.id
}
