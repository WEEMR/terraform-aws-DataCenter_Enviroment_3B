...
variable "spoke_3_wan1_subnet_id" {}

variable "spoke_3_wan2_subnet_id" {}

variable "spoke_3_private_subnet_id" {}

variable "spoke_3_pvt_rt_id" {}
...
variable "spoke3_Configurations" {
  type    = string
  default = "spoke3_fgtvm.conf"
}
