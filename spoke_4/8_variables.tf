...
variable "spoke_4_wan1_subnet_id" {}

variable "spoke_4_wan2_subnet_id" {}

variable "spoke_4_private_subnet_id" {}

variable "spoke_4_pvt_rt_id" {}
...
variable "spoke4_Configurations" {
  type    = string
  default = "spoke4_fgtvm.conf"
}
